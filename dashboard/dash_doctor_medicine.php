		   ...
		   <div class="mdc-layout-grid">	  
	   		...
	   		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Offered Medicines</h6><br>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      <thead>
                        <tr>
                          <th class="text-right">Drug ID</th>
                          <th>Medicine Name</th>
                          <th>Generic</th>
                          <th>Company</th>
                          <th>Power</th>
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT `medid`, `med_name`, `power`,(select med_generic.generic_name from med_generic WHERE med_generic.genericid=medicine.genericid) AS generic, (SELECT pharmaceutical.name FROM pharmaceutical WHERE pharmaceutical.company_id=medicine.company_id) AS company, `type`, `rate`, `description` FROM `medicine`";
						   $result2=$conn->query($sql);
						   while($row2=$result2->fetch_assoc())
						   {	   
						?>		
						<tr>
                          <td><?php echo $row2['medid'];?></td>
                          <td><?php echo $row2['med_name'];?></td>
                          <td><?php echo $row2['generic'];?></td>
