...
{
	$sql2 = "UPDATE `login` SET `login_access`='1' WHERE `patient_id`=$inactive_id";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Rpatient.php');
}
?>
                ...
                <div class="mdc-card p-0">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT patients.patient_id, patients.fname, patients.lname, patients.dob, patients.gender, patients.blood, patients.phone, patients.email, patients.nid FROM patients INNER JOIN login ON patients.patient_id = login.patient_id WHERE login.login_access = 0";
						...
						<tr>
                          ...
                          <?php echo "<td align='center'> <a title='Give approval key' href=\"dash_admin_Rpatient.php?patient_id=$row2[patient_id]\"onClick=\"return confirm('Are you sure to Approve this user?')\"><i class='material-icons'>vpn_key</i></a></td>" ?>
                        </tr>
