...
<?php 
error_reporting(0);
$inactive_id = $_GET['patient_id'];
if (isset($_GET['patient_id']))
{
	$sql2 = "UPDATE `login` SET `login_access`='0' WHERE `patient_id`=$inactive_id";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Apatient.php');
}
?>
	   ...
	   <div class="mdc-layout-grid">	  
		...
		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">All Patients</h6><br>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT patients.patient_id, patients.fname, patients.lname, patients.dob, patients.gender, patients.blood, patients.phone, patients.email, patients.nid FROM patients INNER JOIN login ON patients.patient_id = login.patient_id WHERE login.login_access = 1";
						...
						<tr>
                          ...
                          <td><?php echo $row2['nid'];?></td>
                          <?php echo "<td align='center'> <a title='Inactive this user' href=\"dash_admin_Apatient.php?patient_id=$row2[patient_id]\"onClick=\"return confirm('Are you sure to Inactivate this user?')\"><i class='material-icons'>do_not_disturb</i></a></td>" ?>
                        </tr>
