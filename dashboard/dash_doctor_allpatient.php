                ...
                <div class="mdc-card p-0">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT `patient_id`, `fname`, `lname`, `dob`, `gender`, `blood`, `nid`, (select district_name from district where district_id = patients.district_id) AS district,`nationality` FROM `patients`";
