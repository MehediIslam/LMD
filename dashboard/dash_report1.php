      ...
      <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
          <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <span class="mdc-top-app-bar__title">Current Top Medicines <?php echo "(".date("Y",strtotime("-1 year"))." - ".date("Y").")";?></span>
        ...
        <main class="content-wrapper">
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
			  ...
			  <!-- BarChart: Top Medicine -->
              <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
                <div class="mdc-card">
                  <h6 class="card-title">Top Medicine Prescribed</h6><br>
                  <canvas id="barChart"></canvas>
                </div>
              </div>
			  
			  <!-- AreaChart: Most Drug Generic -->
			  <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
                <div class="mdc-card">
                  <h6 class="card-title">Most Drug-Generic used</h6><br>
