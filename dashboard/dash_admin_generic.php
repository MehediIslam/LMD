...
if (isset($_POST['add']))
{
	$add_Gname = $_POST['generic_name'];
	
	$sql = "INSERT INTO `med_generic`(`generic_name`, `status`) VALUES ('$add_Gname','1')";
		   ...
		   <div class="mdc-layout-grid">	  
            <div class="mdc-layout-grid__inner">
			  ...
			  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                <div class="mdc-card">
				<!-- do code here -->
				<form id="reg-form" action="dash_admin_generic.php" method="post" enctype="multipart/form-data">
