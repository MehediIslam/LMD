  ...
  <div class="body-wrapper">
    ...
    <div class="main-wrapper mdc-drawer-app-content">
     ...
     <div class="page-wrapper mdc-toolbar-fixed-adjust">
		...
		<?php
		   $sql = "SELECT DISTINCT doctors.fname,doctors.lname,doctors.phone,doctors.email,doctors.degrees,(select specialization.specialization from specialization WHERE specialization.specialize_id = doctors.specialize_id) AS specialization,doctors.chamber from doctors INNER JOIN prescription ON doctors.doc_id = prescription.doc_id WHERE patient_id = $patient_id";
		  ...
		  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
			<div class="mdc-card info-card info-card--info">
			  <div class="card-inner">
				...
				<h6 class="font-weight-light pb-2 mb-1 border-bottom"><?php echo $row2['degrees'];?></h6>
				<h6 class="font-weight-light pb-2 mb-1 border-bottom"><?php echo "Cell: ".$row2['phone']."<br>".$row2['email'];?></h6>
