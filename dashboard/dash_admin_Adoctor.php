...
<?php 
error_reporting(0);
$inactive_doc = $_GET['doc_id'];
if (isset($_GET['doc_id']))
{
	$sql2 = "UPDATE `login` SET `login_access`='0' WHERE `doc_id`=$inactive_doc";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Adoctor.php');
}
?>
		   ...
		   <div class="mdc-layout-grid">	  
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">All Doctors</h6><br>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT doctors.doc_id, doctors.fname, doctors.lname, doctors.dob, doctors.gender, doctors.blood, doctors.phone, doctors.email, doctors.license_no FROM doctors INNER JOIN login ON doctors.doc_id = login.doc_id WHERE login.login_access = 1";
						...
						<tr>
                          ...
                          <?php echo "<td align='center'> <a title='Inactive this user' href=\"dash_admin_Adoctor.php?doc_id=$row2[doc_id]\"onClick=\"return confirm('Are you sure to Inactivate this user?')\"><i class='material-icons'>do_not_disturb</i></a></td>" ?>
                        </tr>
