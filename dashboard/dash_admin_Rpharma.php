...
{
	$sql2 = "UPDATE `login` SET `login_access`='1' WHERE `company_id`=$inactive_id";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Rpharma.php');
}
?>
		   ...
		   <div class="mdc-layout-grid">	  
			...
			<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">New registered</h6><br>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT pharmaceutical.company_id, pharmaceutical.name, pharmaceutical.contact,pharmaceutical.email,pharmaceutical.web,pharmaceutical.trade_license FROM pharmaceutical INNER JOIN login ON pharmaceutical.company_id = login.company_id WHERE login.login_access=0";
						...
						<tr>
                          ...
                          <?php echo "<td align='center'> <a title='Give approval key' href=\"dash_admin_Rpharma.php?company_id=$row2[company_id]\"onClick=\"return confirm('Are you sure to Approve this user?')\"><i class='material-icons'>vpn_key</i></a></td>" ?>
                        </tr>
