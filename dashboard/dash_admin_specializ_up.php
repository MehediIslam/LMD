...
<?php
error_reporting(0);
$get_id = $_GET['specialize_id'];
$id = $_SESSION["id"] = $get_id;  

if (isset($_GET['specialize_id']))
{
   $sql3 = "SELECT * FROM `specialization` WHERE `specialize_id`=$get_id";
   $result=$conn->query($sql3);
   while($row3=$result->fetch_assoc()){
	   $oldname = $row3['specialization'];
   }
}

if (isset($_POST['update']))
{
	$updated_Sn = $_POST['specialization'];
	$sql4 = "UPDATE `specialization` SET `specialization`='$updated_Sn' WHERE `specialize_id`=$id";
		   ...
		   <div class="mdc-layout-grid">	  
            <div class="mdc-layout-grid__inner">
			  ...
			  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                <div class="mdc-card">
				<!-- do code here -->
				<form id="reg-form" action="dash_admin_specializ_up.php?specialize_id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">	
				  <div class="template-demo">
					<div class="mdc-layout-grid__inner">
					  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
						 <div class="mdc-text-field mdc-text-field--outlined">
						  <input class="mdc-text-field__input" id="text-field-hero-input" value=<?php echo $oldname;?> required name="specialization">
						  <div class="mdc-notched-outline">
							<div class="mdc-notched-outline__leading"></div>
							<div class="mdc-notched-outline__notch">
							  <label for="text-field-hero-input" class="mdc-floating-label" >Update Specialization</label>
							</div>
							<div class="mdc-notched-outline__trailing"></div>
						  </div>
						</div>
