...
{
	$sql2 = "UPDATE `login` SET `login_access`='1' WHERE `doc_id`=$inactive_doc";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Rdoctor.php');
}
?>
                ...
                <div class="mdc-card p-0">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT doctors.doc_id, doctors.fname, doctors.lname, doctors.dob, doctors.gender, doctors.blood, doctors.phone, doctors.email, doctors.license_no FROM doctors INNER JOIN login ON doctors.doc_id = login.doc_id WHERE login.login_access = 0";
						...
						<tr>
                          ...
                          <?php echo "<td align='center'> <a title='Give approval key' href=\"dash_admin_Rdoctor.php?doc_id=$row2[doc_id]\"onClick=\"return confirm('Are you sure to Approve this user?')\"><i class='material-icons'>vpn_key</i></a></td>" ?>
                        </tr>
