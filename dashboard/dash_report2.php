      ...
      <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
          <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <span class="mdc-top-app-bar__title">Current Common Disease</span>
        ...
        <main class="content-wrapper">
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
			  ...
			  <!-- LineChart: Common Disease Occurred -->
			  <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-10-desktop">
                <div class="mdc-card">
                  <h6 class="card-title">Common Disease occurred <?php echo "(".date("Y",strtotime("-1 year"))." - ".date("Y").")";?></h6><br>
