...
<?php 
error_reporting(0);
$inactive_id = $_GET['company_id'];
if (isset($_GET['company_id']))
{
	$sql2 = "UPDATE `login` SET `login_access`='0' WHERE `company_id`=$inactive_id";
	$result2=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_admin_Apharma.php');
}
?>
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
		...
		<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">All Pharmaceuticals</h6><br>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      ...
                      <tbody>
                         <?php
						   $sql = "SELECT pharmaceutical.company_id, pharmaceutical.name, pharmaceutical.contact,pharmaceutical.email,pharmaceutical.web,pharmaceutical.trade_license FROM pharmaceutical INNER JOIN login ON pharmaceutical.company_id = login.company_id WHERE login.login_access =1";
						...
						<tr>
                          ...
                          <td><?php echo $row2['web'];?></td>
                          <td><?php echo $row2['trade_license'];?></td>
						  
                          <?php echo "<td align='center'> <a title='Inactive this user' href=\"dash_admin_Apharma.php?company_id=$row2[company_id]\"onClick=\"return confirm('Are you sure to Inactivate this user?')\"><i class='material-icons'>do_not_disturb</i></a></td>" ?>
                        </tr>
