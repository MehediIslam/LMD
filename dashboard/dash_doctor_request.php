...
if (isset($_POST['add'])){
	...
	echo $disease_area = $_POST['disease_area'];
	$sql2 = "INSERT INTO `disease`(`disease_name`, `status`) VALUES ('$disease_area','0')";
	$result=$conn->query($sql2);
	mysqli_close($conn);
	header('Location: dash_doctor_request.php');
}
				...
				<div class="mdc-layout-grid__inner">
				  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
					 <div class="mdc-text-field mdc-text-field--outlined">
					  <input class="mdc-text-field__input" id="text-field-hero-input" required name="disease_area">
